...
{
    /// <inheritdoc />
    public partial class V20260714_Phase3Foundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Segment = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "new"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Station = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "kitchen"),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "PREPARING"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_TenantId_ProductId_OccurredAt",
                table: "InventoryMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KitchenOrders_TenantId_Status",
                table: "KitchenOrders",
